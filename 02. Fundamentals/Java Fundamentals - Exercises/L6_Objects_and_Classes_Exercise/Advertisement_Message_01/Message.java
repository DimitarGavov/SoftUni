package Objects_and_Classes_Exercise_06.Advertisement_Message_01;

import java.util.Random;

public class Message {
    private String[] phases = {"Excellent product.", "Such a great product.", "I always use that product.", "Best product of its category", "Exceptional product.", "I can’t live without this product."};
    ...
    public String randomMessage() {
        return String.format("%s %s %s - %s",
                phases[random.nextInt(phases.length)],
